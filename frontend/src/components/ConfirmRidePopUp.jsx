  ...
  return (
    ...
    <h5 className='p-1 text-center w-[93%] absolute top-0' onClick={() => {
         ...
         <div className='flex gap-2 justify-between flex-col items-center'>
             ...
             }} className='w-full mt-2 bg-green-600 text-white font-semibold p-2 rounded-lg'> Confirm </Link>

             <button onClick={() => {
              props.setConfirmridePopupPanel(false)
              props.setridePopupPanel(false)
             }} className='w-full mt-2 bg-red-500 text-white-700  font-semibold p-2 rounded-lg'> Cancel </button>
         </div> 
 </div>
  )
}
